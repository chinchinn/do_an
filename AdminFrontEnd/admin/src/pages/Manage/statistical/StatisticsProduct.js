...
import { Row, Col, Select, Button, Skeleton, Space } from 'antd';
...
export default class StatisticsProduct extends Component {
  ...
  callApiOrder = async () => {
    ...
    let data = await axiosInstance('Statistics/StatusOrderStatistics', 'GET')
      .then(res => { this.setState({ isLoading: false }); return res.data })
          ...
          <div className="content">
            ...
            <br />
            {
              this.state.isLoading ?
                <Skeleton.Input size={"1"} style={{ width: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: 20 }}></Skeleton.Input>
                : <Row>
